...
tap.test('avoid hitting the west wall', function (t) {
  ...
  const result = move(game)
  t.ok(result.move === 'up' || result.move === 'down', 'should move up or down when traveling westbound into the west wall')
  t.end()
})
...
tap.test('avoid hitting the northwest corner', function (t) {
  ...
  const expected = 'down'
  const result = move(game)
  t.equal(result.move, expected, 'should move down when traveling west into the northwest corner')
...
tap.test('avoid hitting the southwest corner, southbound', function (t) {
  ...
  const result = move(game)
  t.equal(result.move, expected, 'should move right when traveling south into the southwest corner')
